...
typedef PcVideoPlayerWidgetController = FFmpegVideoPlayerWidgetController;

class PcVideoPlayerWidget extends StatelessWidget {
  final String? url;
  ...
  Widget build(BuildContext context) {
    return FFmpegVideoPlayerWidget(
      ...
      onWebFullscreenChanged: onWebFullscreenChanged,
      live: live,
    );
  }
}
